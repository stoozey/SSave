...
#macro BLOCK_Y (PLAYER_BASE_Y - 52)
...
draw_sprite(_spriteIndex, 0, FLOOR_X, _playerY);
...
// coin
var _coinAnimReversed = (1 - coinAnim); 
var _coinY = (COIN_BASE_Y - (COIN_ANIM_HEIGHT * _coinAnimReversed));
var _coinScale = (coinAnim * (1.25 + (0.5 * coinIndex)));
draw_sprite_ext(spr_ssave_demo_coin, coinIndex, COIN_X, _coinY, _coinScale, _coinScale, 0, c_white, coinAnim);

// text
draw_set_colour(c_black);
	draw_text_transformed(0, 0, "Total Coins: " + string(totalCoins), 1, 1, 0);
draw_set_alpha(coinAnim);
	var _textAmount = GetCoinAmount();
	var _textY = (BLOCK_Y - 16 - (64 * _coinAnimReversed));
	var _textScale = max(0.15, (coinAnim * (coinIndex + 1)));
